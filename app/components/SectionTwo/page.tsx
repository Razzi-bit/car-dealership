...
const SectionWeRecommend = () => {
  return (
    <div className="relative h-full lg:min-h-screen w-full text-left py-[60px] px-4 max-w-[1200px] mx-auto my-0 flex flex-col justify-center">
      ...
      <SectionTwoSlider />
      <div className="border-Cgray/50 border-l border-r border-t z-[-1] absolute top-[60%] bottom-0 left-0 right-0 lg:right-[-100px] lg:left-[-100px]" />
    </div>
  );
};

export default SectionWeRecommend;
